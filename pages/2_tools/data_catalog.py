...
st.title(f"{render_icon('logo')} Catalog")

st.markdown(
    "Welcome to the generic Data Platform Boilerplate! \n\n"
    "Explore and discover our ecosystem of data models, designed to ensure "
    "traceability, quality, and transparency across all analytical layers."
)
